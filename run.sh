...
#[ -d $HOME/anaconda3/include /usr/include/gflags/ ] || sudo apt -y install libgflags-dev
[ -d $HOME/anaconda3/include/gflags/ ] || sudo apt -y install libgflags-dev
